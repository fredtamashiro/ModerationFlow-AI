...
export const evaluationDatasets: EvaluationDataset[] = [
  {
    ...
    tuningUsage: "Já foi usado para tuning do baseline heurístico; não mede generalização externa.",
  ...
  },
  {
    ...
    label: "Holdout",
    shortLabel: "Holdout",
    role: "Verificação separada durante tuning heurístico.",
    benchmarkStatus: "Benchmark documentado.",
    tuningUsage: "Não deve virar alvo de iteração indefinida.",
  ...
  },
  {
    ...
    label: "Blind",
    shortLabel: "Blind",
    role: "Generalização fora dos conjuntos conhecidos.",
    benchmarkStatus: "Benchmark documentado.",
  ...
  },
  {
    ...
    shortLabel: "Safety",
    role: "Regressão sensível para R-004 e discriminação.",
    benchmarkStatus: "Benchmark documentado.",
    tuningUsage: "Deve proteger casos de segurança, sem decidir sozinho a estratégia geral.",
  ...
  },
  {
    ...
    role: "Validação independente após ciclos de tuning.",
    benchmarkStatus: "Benchmark documentado.",
    tuningUsage: "Não deve virar fonte imediata de novo tuning.",
    description: "Conjunto novo com 30 exemplos sintéticos para auditoria externa da versão atual.",
  },
];
...
export const methodologyCards = [
  ...evaluationDatasets,
  {
    ...
    benchmarkStatus: "Não é benchmark.",
    tuningUsage: "Pode orientar experimentos, mas não deve ser usado como métrica de avaliação.",
...
export const evaluationStrategies: EvaluationStrategy[] = [
  {
    ...
    label: "Heuristico",
    role: "main_flow",
    summary: "Fluxo principal atual: rápido, determinístico, auditável e sempre seguido de HITL.",
  },
  {
    key: "baseline_llm",
    label: "Baseline LLM",
    role: "research_baseline",
    summary: "Referência principal de pesquisa para medir generalização sem exemplos few-shot.",
  },
  {
    key: "static_few_shot",
    label: "Few-shot estatico",
    role: "historical_experiment",
    summary: "Experimento com exemplos humanos fixos; não trouxe ganho consistente.",
  },
  {
...
export const evaluationResults: EvaluationResult[] = [
  ...
  },
  {
    ...
    averageLatencyMs: 5,
    failedRuns: 0,
    observations: "Generalização parcial fora dos conjuntos conhecidos.",
  ...
  },
  {
    ...
    averageLatencyMs: null,
    failedRuns: 0,
    observations: "Rodada simples após calibragem de spam explícito e fronteira de alvo.",
  ...
  },
  {
    ...
    averageLatencyMs: null,
    failedRuns: 0,
    observations: "Guardrail manteve action/risk, mas não foi melhor que a variante base no blind.",
    source: "docs/evaluation.md, Etapa 039 compare-ablation",
    snapshotKind: evaluationSnapshotKind,
  },
  {
  ...
  },
  {
    ...
    averageLatencyMs: null,
    failedRuns: 0,
    observations: "Estratégia completa permaneceu estável no safety após calibragem.",
    source: "docs/evaluation.md, Etapa 039",
    snapshotKind: evaluationSnapshotKind,
  },
  {
  ...
  },
  {
    ...
    averageLatencyMs: null,
    failedRuns: 0,
    observations: "Variante base empatou com baseline LLM na comparação adversarial.",
    source: "docs/evaluation.md, Etapa 040 compare-ablation",
    snapshotKind: evaluationSnapshotKind,
  },
  {
    ...
    averageLatencyMs: null,
    failedRuns: 0,
    observations: "Guardrailed perdeu action/risk nesta comparação; não é melhor modelo geral.",
    source: "docs/evaluation.md, Etapa 040 compare-ablation",
    snapshotKind: evaluationSnapshotKind,
  },
];
